...
\begin{frame}{Depth-first search}
  ...
  \begin{block}{}
    \begin{description}
      \item<1-58>[Pre-order (NLR)] \only<2->{\only<2|handout:0>\emphr{1}} \only<4->{\only<4|handout:0>\emphr{2}} \only<6->{\only<6|handout:0>\emphr{4}} \only<8->{\only<8|handout:0>\emphr{5}} \only<10->{\only<10|handout:0>\emphr{7}} \only<12->{\only<12|handout:0>\emphr{8}} \only<14->{\only<14|handout:0>\emphr{3}} \only<16->{\only<16|handout:0>\emphr{6}} \only<18->{\only<18|handout:0>\emphr{9}}
      \item<20->[In-order (LNR)] \only<23->{\only<23|handout:0>\emphr{4}} \only<24->{\only<24|handout:0>\emphr{2}} \only<27->{\only<27|handout:0>\emphr{7}} \only<28->{\only<28|handout:0>\emphr{5}} \only<30->{\only<30|handout:0>\emphr{8}} \only<31->{\only<31|handout:0>\emphr{1}} \only<33->{\only<33|handout:0>\emphr{3}} \only<36->{\only<36|handout:0>\emphr{9}} \only<37->{\only<37|handout:0>\emphr{6}}
      \item<39->[Post-order (LRN)] \only<42->{\only<42|handout:0>\emphr{4}} \only<45->{\only<45|handout:0>\emphr{7}} \only<47->{\only<47|handout:0>\emphr{8}} \only<48->{\only<48|handout:0>\emphr{5}} \only<49->{\only<49|handout:0>\emphr{2}} \only<53->{\only<53|handout:0>\emphr{9}} \only<54->{\only<54|handout:0>\emphr{6}} \only<55->{\only<55|handout:0>\emphr{3}} \only<56->{\only<56|handout:0>\emphr{1}}
    \end{description}
  \end{block}
\end{frame}
...
%  \framesubtitle{From traversals to tree}
  ...
  \begin{block}{}
    ...
    \begin{tikzpicture}[scale = 0.9]
      \draw[bleu] (0, 4.5) node[left] {Pre-order (NLR)};
      \draw[bleu] (0, 4) node[left] {In-order (LNR)};
...
%    \draw (1) -- (2) (1) -- (3) (2) -- (4) (2) -- (5) (3) -- (6) (5) -- (7) (5) -- (8) (6) -- (9);
  ...
  \begin{block}{}
    \centering
    \begin{tikzpicture}[scale = 0.9]
      \draw[bleu] (0, 4.5) node[left] {Post-order (LRN)};
      \draw[bleu] (0, 4) node[left] {In-order (LNR)};
  ...
  \begin{block}{}
    ...
    \begin{tikzpicture}[scale = 0.9]
      \draw[bleu] (0, 4.5) node[left] {Pre-order (NLR)};
      \draw[bleu] (0, 4) node[left] {Post-order (LRN)};
