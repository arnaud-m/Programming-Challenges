    ...
    \begin{tikzpicture}[scale = 0.45]
      ...
      \uncover<2->{
        ...
        \foreach \x in {-0.5, 0.5, ..., 3.5}
          \draw (\x, -4.5) -- (\x, -3.5);
        \draw (-1, -4) node {\only<4->{\only<4>\emph{1}}};
        \draw (0, -4) node {\only<6->{\only<6>\emph{2}}};
        \draw (1, -4) node {\only<8->{\only<8>\emph{3}}};
        \draw (2, -4) node {\only<10->{\only<10>\emph{5}}};
        \draw (3, -4) node {\only<12->{\only<12>\emph{7}}};
        \draw (4, -4) node {\only<14->{\only<14>\emph{9}}};
      }
    \end{tikzpicture}
  \end{block}
...
\begin{frame}[fragile]{Exercise 2: Inversion Count}
  ...
  \begin{code}{Solution 2: Using Merge sort}
    ...
    \begin{tikzpicture}[scale = 0.45]
      ...
      \only<8->{\draw[rose, thick] (4, -1) -- (4, -2);}
      \uncover<9->{
      \draw[rose, ->] (3.5, -2.2) -- (3, -2.8);
      \draw[rose, ->] (5, -2.2) -- (5.5, -2.8);
      ...
      \only<10->{\draw[rose, thick] (5.5, -4) -- (5.5, -3);}
      \uncover<11->{
      \draw[rose, ->] (5, -4.2) -- (4.5, -4.8);
      \draw[rose, ->] (6, -4.2) -- (6.5, -4.8);
      ...
      \draw (4.5, -9.5) node {6};
      \draw (5.5, -9.5) node {8};
      \draw (6, -9.5) node[right] {\emph{+ 1 + 1}};
      }
      ...
      \draw (0.5, -11.5) node {1};
      \draw (1.5, -11.5) node {2};
      \draw (2.5, -11.5) node {3};
      \draw (3.5, -11.5) node {6};
      \draw (4.5, -11.5) node {8};
