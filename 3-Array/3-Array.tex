...
\begin{frame}{Exercise 3: Longest Connected Subsequence}
  ...
  \begin{block}{Representation}
    ...
    \begin{tikzpicture}[scale = 0.5]
      ...
      \only<4|handout:0>{\draw (1.5, 1) node[above] {\scriptsize\emphr{1}};}
      \only<5|handout:0>{\draw (3.5, 1) node[above] {\scriptsize\emphr{3}};}
      \only<6|handout:0>{\draw (9.5, 1) node[above] {\scriptsize\emphr{9}};}
      ...
      \begin{scope}[xshift = 12cm]
        ...
        \only<4->{\draw (1.5, 0.5) node {\only<4|handout:0>\emphr{1}};}
        \only<5->{\draw (2.5, 0.5) node {\only<5|handout:0>\emphr{3}};}
        \only<6->{\draw (3.5, 0.5) node {\only<6|handout:0>\emphr{9}};}
      \end{scope}}
    \end{tikzpicture}
  \end{block}}
